...
# Configuração de logging com arquivo em tempo real
log_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'logs')
os.makedirs(log_dir, exist_ok=True)
log_file = os.path.join(log_dir, 'app_realtime.log')

# Configuração de logging com RotatingFileHandler para logs em tempo real
logging.basicConfig(
    level=logging.INFO,
